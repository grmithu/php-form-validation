                        ...
                        <div class="flex items-center px-2 lg:px-0">
                            <div class="hidden sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="./index.html" class="bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium" aria-current="page">Home</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-t border-emerald-700 pb-3 pt-4">
                        <div class="flex items-center px-5">
                            <div class="flex-shrink-0">
                                <img class="h-10 w-10 rounded-full" src="https://avatars.githubusercontent.com/u/61485238?v=4" alt="" />
                            </div>
                            <div class="ml-3">
